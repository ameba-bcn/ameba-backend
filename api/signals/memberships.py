...
from api.tasks.memberships import schedule_reminders
...
def trigger_notifications(sender, member, subscription, **kwargs)
    # Trigger reminders
    schedule_reminders(schedule=0)

    # Trigger new member signal
    new_member.send(sender=Membership)
