...
class TestStripeWebhooks(helpers.BaseTest):
    ...
    def test_failed_payment_creates_payment_but_has_no_effect(self):
        member = user_helpers.get_member()
        ...
        invoice = stripe_helper.get_invoice(user=member.user, item_variants=[
            s_variant], status='open'
        )
    ...
    def test_failed_renew_notifies_user_and_cancel_subscription(self):
        pass
