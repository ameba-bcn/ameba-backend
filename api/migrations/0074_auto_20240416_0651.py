# Generated by Django 3.2 on 2024-04-16 06:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='member',
            name='qr',
            field=models.ImageField(blank=True, null=True, upload_to='member_qr'),
        ),
        ...
        migrations.AlterField(
            model_name='member',
            name='description',
            field=models.TextField(max_length=2500, null=True, verbose_name='biografía'),
        ),
        migrations.AlterField(
            model_name='member',
            name='first_name',
        ...
        migrations.AlterField(
            model_name='member',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='members', to='api.ArtistTag', verbose_name='etiquetas'),
        ),
        migrations.AlterField(
            model_name='memberprofileimage',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='api.member', verbose_name='socio'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='payment',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payments', to=settings.AUTH_USER_MODEL, verbose_name='usuario'),
        ),
        migrations.AlterField(
            model_name='question',
            name='is_default',
